...
public class NewTask {
    public static void main(String[] args) {
                ...
                if (secim < 3) {
                    System.out.printf("Seçtiğiniz araç: %s Fiyatı: %5.2f'dir. İyi günlerde kullanın.", cars[secim - 1], price1);
                } else if (secim >= 3 & secim < 5) {
                    System.out.printf("Seçtiğiniz araç: %s Fiyatı: %5.2f'dir. İyi günlerde kullanın.", cars[secim - 1], price2);
                } else if (secim >= 5 & secim < 7) {
                    System.out.printf("Seçtiğiniz araç %s dir. Fiyatı %5.2f dir. İyi günlerde kullanın.", cars[secim - 1], price3);
